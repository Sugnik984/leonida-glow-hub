...
const LeonidaFeed = () => {
  ...
  return (
    <motion.div
      className="glass-holographic rounded-xl overflow-hidden flex flex-col h-full holo-border"
              ...
              >
                ...
                <AnimatePresence>
                  {hoveredId === item.id && (
                    <motion.div
                      ...
                      style={{
                        background: `linear-gradient(135deg, hsl(${cfg.hsl} / 0.08), transparent 60%)`,
                      }}
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0 }}
                ...
                <div className="flex items-start gap-2.5 relative z-10">
                  <div
                    ...
                    style={{
                      background: `hsl(${cfg.hsl} / 0.1)`,
                      border: `1px solid hsl(${cfg.hsl} / 0.2)`,
                    }}
                  >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="font-display text-[8px] tracking-[0.15em] text-muted-foreground mt-1 uppercase">
                      {item.subtitle}
                    </p>
                  </div>
                </div>
